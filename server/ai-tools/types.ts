...
/**
 * Anthropic native tool format passed to the Claude API's `tools` parameter.
 *
 * Generated by {@link ToolRegistry.toAnthropicTools} from registered {@link ToolDefinition}s.
 *
 * @property name         - Tool name matching {@link ToolDefinition.name}.
 * @property description  - Tool description for the model.
 * @property input_schema - JSON Schema object derived from the Zod parameters via `zod-to-json-schema`.
 *
...
/**
 * Gemini function declaration format passed to the Gemini API's `functionDeclarations`.
 *
 * Generated by {@link ToolRegistry.toGeminiFunctionDeclarations} from registered {@link ToolDefinition}s.
 *
 * @property name        - Tool name matching {@link ToolDefinition.name}.
 * @property description - Tool description for the model.
 * @property parameters  - JSON Schema object derived from the Zod parameters via `zod-to-json-schema`.
 *
