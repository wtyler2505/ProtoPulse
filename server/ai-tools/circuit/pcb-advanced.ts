 ...
 * suggestions.
 *
 * Note: `suggest_trace_path` (autorouter integration) lives in
 * `./pcb-autoroute.ts` — extracted to keep this module under the 400-line
 * size budget and focused on zone/teardrop/naming heuristics.
 *
