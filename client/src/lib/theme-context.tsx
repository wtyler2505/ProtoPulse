...
const NEON_CYAN: ThemePreset = {
  ...
  label: 'Neon Cyan',
  colors: {
    '--color-background': '#030405',
    '--color-foreground': '#E0E6EB',
    '--color-card': '#0A0C0F',
    '--color-card-foreground': '#E0E6EB',
    '--color-popover': '#0A0C0F',
    '--color-popover-foreground': '#E0E6EB',
    '--color-primary': '#00B7DB',
    '--color-primary-foreground': '#060709',
    '--color-secondary': '#884DFF',
    '--color-secondary-foreground': '#FFFFFF',
    '--color-muted': '#16181D',
    '--color-muted-foreground': '#929EAF',
    '--color-accent': '#00B7DB',
    '--color-accent-foreground': '#060709',
    '--color-editor-accent': '#00F0FF',
    '--color-destructive': '#EE2B2B',
    '--color-destructive-foreground': '#FFFFFF',
    '--color-border': '#2D3039',
    '--color-input': '#2D3039',
    '--color-ring': '#00B7DB',
    '--color-sidebar': '#050507',
    '--color-sidebar-border': '#2D3039',
  },
};
