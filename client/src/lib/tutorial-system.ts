  ...
  return [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          targetElement: '[data-testid="chat-panel"]',
          position: 'left',
          canSkip: true,
          order: 4,
        },
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          targetView: 'procurement',
          targetElement: '[data-testid="input-quantity"]',
          position: 'right',
        ...
        },
        {
          ...
          targetView: 'procurement',
          targetElement: '[data-testid="input-unit-price"]',
          position: 'right',
        ...
        },
        {
          ...
          targetView: 'procurement',
          targetElement: '[data-testid="input-supplier"]',
          position: 'right',
        ...
        },
        {
          ...
          targetView: 'procurement',
          targetElement: '[data-testid="button-export-bom"]',
          position: 'bottom',
          requiredAction: 'click',
          canSkip: true,
          order: 4,
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          targetView: 'schematic',
          targetElement: '[data-testid="button-add-component"]',
          position: 'bottom',
          requiredAction: 'click',
          canSkip: true,
          order: 1,
        ...
        },
        {
          ...
          targetView: 'schematic',
          targetElement: '[data-testid="button-run-dc-analysis"]',
          position: 'bottom',
          requiredAction: 'click',
          canSkip: false,
          order: 3,
        ...
        },
        {
          ...
          targetView: 'schematic',
          targetElement: '[data-testid="button-run-ac-analysis"]',
          position: 'bottom',
          requiredAction: 'click',
          canSkip: true,
          order: 5,
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          targetView: 'output',
          targetElement: '[data-testid="button-export-kicad"]',
          position: 'bottom',
          requiredAction: 'click',
          canSkip: true,
          order: 1,
        },
        {
          ...
          targetView: 'output',
          targetElement: '[data-testid="button-export-gerber"]',
          position: 'bottom',
          requiredAction: 'click',
          canSkip: true,
          order: 2,
        },
        {
          ...
          targetView: 'output',
          targetElement: '[data-testid="button-export-report"]',
          position: 'bottom',
          requiredAction: 'click',
          canSkip: true,
          order: 3,
