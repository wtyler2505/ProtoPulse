...
export default function ReleaseConfidenceCard({
  ...
  return (
    <div className="rounded-lg border border-border bg-card/40 p-3 space-y-3" data-testid={dataTestId}>
      <div className="flex items-start justify-between gap-2.5 flex-wrap">
        <div className="space-y-1">
          <h4 className="text-xs font-semibold" data-testid="release-confidence-title">
            {title}
          </h4>
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          <Badge variant="outline" className="text-[10px] px-1.5 py-0" data-testid="release-confidence-evidence">
            {result.confidence.evidenceLabel}
          </Badge>
        </div>
      </div>

      <p className="text-xs leading-5 text-foreground/90" data-testid="release-confidence-summary">
        {result.confidence.summary}
      </p>

      <div className="grid gap-3 lg:grid-cols-2">
        <div className="space-y-1.5" data-testid="release-confidence-blockers">
        ...
        <div className="space-y-1.5" data-testid="release-confidence-actions">
          <div className="text-xs font-medium uppercase tracking-wide text-muted-foreground">
            Next actions
          </div>
          <ul className="space-y-1.5">
