...
function ImportHistoryPanel({ onRestore }: ImportHistoryPanelProps) {
  ...
  if (count === 0) {
    return (
      <div className="px-2.5 py-3 text-center" data-testid="import-history-empty">
  ...
  return (
    <div className="flex flex-col gap-0.5" data-testid="import-history-panel">
      ...
      <div className="flex items-center justify-between px-2.5 py-0.5">
        ...
        <StyledTooltip content="Clear all import history" side="left">
          <button
            ...
            className="p-0.5 text-muted-foreground/50 hover:text-destructive transition-colors focus-ring"
            onClick={clear}
      ...
      <div className="flex flex-col divide-y divide-border/20">
        {entries.map((entry) => (
          <div
            ...
            className={cn(
              'px-2.5 py-1.5 flex flex-col gap-1 hover:bg-muted/20 transition-colors group',
            )}
          >
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <Badge
                variant="outline"
                className="text-[9px] font-mono shrink-0 px-1 py-0 border-primary/30 text-primary/80"
              ...
              <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                <StyledTooltip content="Restore this import" side="left">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="h-5.5 px-1.5 text-[10px] text-primary hover:text-primary hover:bg-primary/10"
