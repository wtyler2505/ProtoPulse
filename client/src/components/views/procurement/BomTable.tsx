    ...
    <ContextMenu>
      <ContextMenuTrigger asChild>
        ...
        >
          ...
          {isEditing ? (
            <>
              <td className="px-4 py-1"><input data-testid={`edit-part-number-${item.id}`} className="w-full bg-primary/5 border border-primary/30 px-2 py-1 text-xs font-mono focus-visible:outline-none focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-cyan-400/50" value={editValues.partNumber} onChange={e => setEditValues(v => ({ ...v, partNumber: e.target.value }))} onKeyDown={handleEditKeyDown} autoFocus /></td>
              <td className="px-4 py-1"><input data-testid={`edit-manufacturer-${item.id}`} className="w-full bg-primary/5 border border-primary/30 px-2 py-1 text-xs focus-visible:outline-none focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-cyan-400/50" value={editValues.manufacturer} onChange={e => setEditValues(v => ({ ...v, manufacturer: e.target.value }))} onKeyDown={handleEditKeyDown} /></td>
              <td className="px-4 py-1"><input data-testid={`edit-description-${item.id}`} className="w-full bg-primary/5 border border-primary/30 px-2 py-1 text-xs focus-visible:outline-none focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-cyan-400/50" value={editValues.description} onChange={e => setEditValues(v => ({ ...v, description: e.target.value }))} onKeyDown={handleEditKeyDown} /></td>
              <td className="px-4 py-1">
                <select data-testid={`edit-supplier-${item.id}`} className="w-full bg-primary/5 border border-primary/30 px-2 py-1 text-xs focus-visible:outline-none focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-cyan-400/50" value={editValues.supplier} onChange={e => setEditValues(v => ({ ...v, supplier: e.target.value }))} onKeyDown={handleEditKeyDown}>
