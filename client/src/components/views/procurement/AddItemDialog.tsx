  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-card border-border sm:max-w-md" data-testid="dialog-add-bom-item">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Select
                ...
                onValueChange={(v) => onNewItemChange((prev) => ({ ...prev, supplier: v }))}
              >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-2">
              ...
              <NumberInput
                ...
                onChange={(e) =>
                  onNewItemChange((prev) => ({ ...prev, quantity: Math.max(1, parseInt(e.target.value) || 1) }))
                }
            ...
            <div className="grid gap-2">
              ...
              <NumberInput
                ...
                onChange={(e) =>
                  onNewItemChange((prev) => ({ ...prev, unitPrice: Math.max(0, parseFloat(e.target.value) || 0) }))
                }
        ...
        <DialogFooter>
          <Button variant="outline" onClick={() => onOpenChange(false)} data-testid="button-cancel-add-item">
            Cancel
          </Button>
