...
export default function BreadboardQuickIntake({ onAdd, onScan, scanResult }: BreadboardQuickIntakeProps) {
  ...
  return (
    <form data-testid="breadboard-quick-intake" onSubmit={handleSubmit} className="space-y-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <Input
          ...
          className="h-8 flex-1 text-xs"
        />
        <Button data-testid="quick-intake-submit" type="submit" size="sm" className="h-8 gap-1 px-2">
