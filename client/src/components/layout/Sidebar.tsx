...
export default function Sidebar({ isOpen, onClose, collapsed = false, width = 256 }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "bg-sidebar border-r border-sidebar-border flex flex-col h-full text-sm select-none shrink-0 overflow-hidden",
        ...
        <div className="mb-6">
          ...
          <div className="mt-2 space-y-0.5">
            <div className="px-4 py-1.5 flex items-center gap-2 text-foreground font-medium">
              ...
              <span className="truncate">Smart_Agro_Node_v1</span>
            </div>
