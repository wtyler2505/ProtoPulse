...
export function CollapsibleSection({
  ...
  return (
    <div className="border-b border-border/50" data-testid={testId}>
      <button
        type="button"
        className="w-full flex items-center gap-2.5 px-4 py-3 text-[11px] font-semibold text-muted-foreground hover:text-foreground hover:bg-muted/20 transition-colors"
