...
| `npm run test:packages` | Run all engine tests (counts: `.ref/project-dna.md`) |
...
```bash
npm test               # All 54 test files, ~1580 tests
...
npm run test:packages            # all package tests (counts: .ref/project-dna.md)
