...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/StyledTooltip.tsx
  var StyledTooltip_exports = {};
  __export(StyledTooltip_exports, {
    NetTooltipOpen: () => NetTooltipOpen,
  ...
  var Popper = (props) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PopperProvider, { scope: __scopePopper, anchor, onAnchorChange: setAnchor, children });
  };
  ...
  var PopperAnchor = React13.forwardRef(
    (props, forwardedRef) => {
      ...
      return virtualRef ? null : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Primitive.div, { ...anchorProps, ref: composedRefs });
    }
  );
  ...
  var TooltipContent2 = React20.forwardRef(({ className, sideOffset = 4, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Portal2, { children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
    Content2,
    {
      ref,
      sideOffset,
  ...
  function StyledTooltip({ children, content, side = "bottom", className, asChild = true }) {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(Tooltip2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(TooltipTrigger2, { asChild, children }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(TooltipContent2, { className: cn(TOOLTIP_CLASS, className), side, children: typeof content === "string" ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { children: content }) : content })
    ] });
  }

  // .design-sync/previews/StyledTooltip.tsx
  var import_jsx_runtime13 = __toESM(require_react_shim(), 1);
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(TooltipProvider2, { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "bg-background text-foreground", style: { padding: 48, minHeight: 180, display: "flex", justifyContent: "center", alignItems: "center" }, children }) });
  function PinTrigger() {
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(StyledTooltip, { content: "Pin 13 · SCK (Serial Clock) — net SCK", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { className: "rounded border border-border bg-card/60 px-3 py-1.5 font-mono text-sm text-primary", children: "U1.19 / SCK" }) }) });
  }
  function NetTooltipOpen() {
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(Tooltip2, { defaultOpen: true, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(TooltipTrigger2, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { className: "rounded border border-border bg-card/60 px-3 py-1.5 font-mono text-sm text-primary", children: "+3V3" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(TooltipContent2, { className: cn(TOOLTIP_CLASS), side: "top", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "Net +3V3 · 14 pins · sourced from AMS1117-3.3 LDO" }) })
    ] }) });
  }
  return __toCommonJS(StyledTooltip_exports);
})();
