  ...
  var Lt = n.forwardRef((A, B) => {
    ...
    n.useImperativeHandle(B, () => l.current, []), n.useEffect(() => {
      ...
      function d() {
        ...
        let c = t.selectionStart, b = t.selectionEnd, mt = t.selectionDirection, v = t.maxLength, C = t.value, _ = V.current.prev, g2 = -1, E = -1, w;
        if (C.length !== 0 && c !== null && b !== null) {
          let Dt = c === b, Ht = c === C.length && C.length < v;
          if (Dt && !Ht) {
            let y = c;
            if (y === 0) g2 = 0, E = 1, w = "forward";
            else if (y === v) g2 = y - 1, E = y, w = "backward";
        ...
        let pt = g2 !== -1 ? g2 : c, Rt = E !== -1 ? E : b, yt = w != null ? w : mt;
    ...
    let O = Tt({ containerRef: K, inputRef: l, pushPasswordManagerStrategy: F, isFocused: j }), st = n.useCallback((t) => {
      ...
      t.preventDefault();
      let p = (g2 = l.current) == null ? void 0 : g2.selectionStart, c = (E = l.current) == null ? void 0 : E.selectionEnd, v = (p !== c ? i.slice(0, p) + R + i.slice(c) : i.slice(0, p) + R + i.slice(p)).slice(0, e);
...
@media (prefers-color-scheme: dark) {
  ...
  var InputOTPSeparator = React.forwardRef(({ ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref, role: "separator", ...props, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Minus, {}) }));
  InputOTPSeparator.displayName = "InputOTPSeparator";

  // .design-sync/previews/InputOTP.tsx
  var import_jsx_runtime2 = __toESM(require_react_shim(), 1);
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bg-background text-foreground", style: { padding: 32, maxWidth: 420 }, children });
  function ShareCode() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "grid", gap: 10 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-sm text-muted-foreground", children: "Enter the 6-digit code to join this design session" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(InputOTP, { maxLength: 6, value: "482915", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(InputOTPGroup, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 0 }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 1 }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 2 })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSeparator, {}),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(InputOTPGroup, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 3 }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 4 }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 5 })
        ] })
      ] })
    ] }) });
  }
  function DeviceClaim() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "grid", gap: 10 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-sm text-muted-foreground", children: "Pairing code shown on the ESP32 serial monitor" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTP, { maxLength: 4, value: "73A", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(InputOTPGroup, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 0 }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 1 }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 2 }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InputOTPSlot, { index: 3 })
