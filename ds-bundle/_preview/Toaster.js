...
var __dsPreview = (() => {
  ...
  __export(Toaster_exports, {
    ...
    TopRightPlacement: () => TopRightPlacement
  });
  init_define_import_meta_env();
  ...
  var Loader = ({ visible, className }) => {
    ...
    }, bars.map((_2, i) => /* @__PURE__ */ import_react.default.createElement("div", {
  ...
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bg-background text-foreground", style: { padding: 24, maxWidth: 460 }, children });
  function ToastRegion() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Surface, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mb-2 text-sm text-muted-foreground", children: "Global sonner toast region. Mounted once near the app root; toasts fired from anywhere (DRC results, save confirmations, upload status) render into this portal." }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Toaster3, {})
    ] });
  }
  function TopRightPlacement() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Surface, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mb-2 text-sm text-muted-foreground", children: "Region pinned to the top-right corner — used while the bottom toolbar holds the simulation transport controls." }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Toaster3, { position: "top-right", richColors: true })
    ] });
  }
