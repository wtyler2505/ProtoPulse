...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ViewOnboardingHint.tsx
  var ViewOnboardingHint_exports = {};
  __export(ViewOnboardingHint_exports, {
    BreadboardHint: () => BreadboardHint,
    PcbHint: () => PcbHint,
  ...
  // client/src/components/ui/ViewOnboardingHint.tsx
  init_define_import_meta_env();
  ...
  // client/src/lib/view-onboarding.ts
  init_define_import_meta_env();
  var import_react = __toESM(require_react_shim());
  var MAX_HINT_VISITS = 3;
  var STORAGE_KEY = "protopulse:view-onboarding";
  var VIEW_HINTS = {
    dashboard: {
  ...
  var ViewOnboardingManager = class _ViewOnboardingManager {
    static instance = null;
    state;
    listeners = /* @__PURE__ */ new Set();
    constructor() {
      this.state = _ViewOnboardingManager.loadState();
    }
    static getInstance() {
      if (!_ViewOnboardingManager.instance) {
        _ViewOnboardingManager.instance = new _ViewOnboardingManager();
      }
      return _ViewOnboardingManager.instance;
    }
    /** Reset singleton — for testing only. */
    static resetInstance() {
      _ViewOnboardingManager.instance = null;
    }
    // -------------------------------------------------------------------------
    // Persistence
    // -------------------------------------------------------------------------
    static loadState() {
      try {
        ...
        if (raw) {
          ...
          if (parsed && typeof parsed === "object" && "visitCounts" in parsed && "dismissed" in parsed) {
            const p = parsed;
            return {
  ...
  function useViewOnboarding(viewName) {
  ...
  function ViewOnboardingHint({ viewName, className }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        "aria-live": "polite",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Lightbulb, { className: "w-5 h-5 text-primary shrink-0 mt-0.5", "aria-hidden": "true" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm font-medium text-foreground", "data-testid": "onboarding-hint-title", children: hint.title }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs text-muted-foreground mt-0.5", "data-testid": "onboarding-hint-description", children: hint.description }),
            remaining > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-[10px] text-muted-foreground/60 mt-1", "data-testid": "onboarding-hint-counter", children: [
              "Showing ",
              remaining,
              " more ",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              type: "button",
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.X, { className: "w-4 h-4" })
            }
          )
        ]
      }
  ...
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bg-background text-foreground", style: { padding: 24, maxWidth: 520 }, children });
  function SchematicHint() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ViewOnboardingHint, { viewName: "schematic" }) });
  }
  function PcbHint() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ViewOnboardingHint, { viewName: "pcb" }) });
  }
  function SimulationHint() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ViewOnboardingHint, { viewName: "simulation" }) });
  }
  function BreadboardHint() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ViewOnboardingHint, { viewName: "breadboard" }) });
  }
  return __toCommonJS(ViewOnboardingHint_exports);
})();
