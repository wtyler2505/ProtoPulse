...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/LifecycleBadge.tsx
  var LifecycleBadge_exports = {};
  __export(LifecycleBadge_exports, {
    PreliminaryPart: () => PreliminaryPart,
    StatusBadges: () => StatusBadges
  });
  init_define_import_meta_env();

  // client/src/components/ui/LifecycleBadge.tsx
  init_define_import_meta_env();
  ...
  // client/src/lib/lifecycle-badges.ts
  init_define_import_meta_env();
  var LIFECYCLE_DB = [
  ...
  function normalizePartNumber(pn) {
    return pn.toLowerCase().trim().replace(/\/nopb$/i, "").replace(/[+#]pbf$/i, "").replace(/\s+/g, "");
  }
  function classifyLifecycle(partNumber, manufacturer) {
    ...
    if (normalizedMfg) {
      const mfgMatch = LIFECYCLE_DB.find(
        (entry) => normalizePartNumber(entry.partNumber) === normalizedPn && entry.manufacturer && normalizedMfg.includes(entry.manufacturer)
      );
      if (mfgMatch) {
    ...
    const pnMatch = LIFECYCLE_DB.find(
      (entry) => normalizePartNumber(entry.partNumber) === normalizedPn && !entry.manufacturer
    );
    if (pnMatch) {
  ...
  function getLifecycleAdvice(status) {
    switch (status) {
      case "active":
  ...
  function LifecycleBadgeInner({ partNumber, manufacturer, status: overrideStatus, className }) {
  ...
  var LifecycleBadge = (0, import_react3.memo)(LifecycleBadgeInner);

  // .design-sync/previews/LifecycleBadge.tsx
  var import_jsx_runtime14 = __toESM(require_react_shim(), 1);
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "bg-background text-foreground", style: { padding: 24, maxWidth: 420 }, children });
  function StatusBadges() {
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: { display: "grid", gap: 12 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex items-center gap-2 text-sm", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "font-mono", children: "NE555P" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(LifecycleBadge, { partNumber: "NE555P", status: "nrnd" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex items-center gap-2 text-sm", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "font-mono", children: "UA741CP" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(LifecycleBadge, { partNumber: "UA741CP", status: "obsolete" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex items-center gap-2 text-sm", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "font-mono", children: "ATmega16-16PU" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(LifecycleBadge, { partNumber: "ATmega16-16PU", status: "eol" })
      ] })
    ] }) });
  }
  function PreliminaryPart() {
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex items-center gap-2 text-sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "font-mono", children: "RP2350-QFN80" }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(LifecycleBadge, { partNumber: "RP2350-QFN80", status: "preliminary" })
    ] }) });
  }
  return __toCommonJS(LifecycleBadge_exports);
})();
