...
var __dsPreview = (() => {
  ...
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(TooltipProvider2, { children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: "bg-background text-foreground", style: { padding: 24, display: "flex", justifyContent: "center" }, children }) });
  function Toolbar() {
