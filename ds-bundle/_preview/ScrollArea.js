...
var __dsPreview = (() => {
  ...
  var ScrollArea2 = React10.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    Root,
    {
      ref,
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Viewport, { className: "h-full w-full rounded-[inherit]", children }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ScrollBar, {}),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Corner, {})
      ]
    }
  ));
  ScrollArea2.displayName = Root.displayName;
  var ScrollBar = React10.forwardRef(({ className, orientation = "vertical", ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
    ScrollAreaScrollbar,
    {
      ref,
      orientation,
      ...
      ...props,
      children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ScrollAreaThumb, { className: "relative flex-1 rounded-full bg-border" })
    }
  ));
  ...
  var use = React11[" use ".trim().toString()];
  ...
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "bg-background text-foreground", style: { padding: 24 }, children });
  var PARTS = [
  ...
  function ComponentList() {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ScrollArea2, { className: "h-64 w-72 rounded-md border border-border bg-card/40", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "p-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "mb-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Components (12)" }),
      PARTS.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center justify-between py-1.5 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "font-mono text-primary", children: p.ref }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "truncate px-2 text-foreground", children: p.part }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "text-xs text-muted-foreground", children: p.pkg })
        ] }),
        i < PARTS.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Separator2, {})
      ] }, p.ref))
    ] }) }) });
  }
  function NetListPanel() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ScrollArea2, { className: "h-56 w-56 rounded-md border border-border bg-card/40", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "p-2", children: nets.map((net) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      "div",
      {
