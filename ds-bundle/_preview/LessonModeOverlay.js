...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/LessonModeOverlay.tsx
  var LessonModeOverlay_exports = {};
  __export(LessonModeOverlay_exports, {
    Active: () => Active,
    StepContext: () => StepContext
  });
  init_define_import_meta_env();

  // client/src/components/ui/LessonModeOverlay.tsx
  init_define_import_meta_env();
  ...
  // client/src/lib/lesson-mode.ts
  init_define_import_meta_env();
  var import_react = __toESM(require_react_shim());
  var LessonMode = class _LessonMode {
    ...
    static getInstance() {
      if (!_LessonMode.instance) {
        _LessonMode.instance = new _LessonMode();
      }
      return _LessonMode.instance;
    }
    static resetInstance() {
      _LessonMode.instance = null;
    }
    // -----------------------------------------------------------------------
    // State accessors
    // -----------------------------------------------------------------------
     ...
     */
    setAllowedControls(allowedSelectors, hint) {
      if (!this.state.active) {
        return;
      }
      this.state = {
        active: true,
        allowedSelectors: [...allowedSelectors],
        hint: hint !== void 0 ? hint : this.state.hint
      };
      this.notify();
    }
    /**
  ...
  var ALLOWED_Z = 9999;
  var BANNER_Z = 1e4;
  var ALLOWED_CLASS = "lesson-mode-allowed";
  function LessonModeOverlay() {
    const { active, allowedSelectors, hint, disable } = useLessonMode();
    const observerRef = (0, import_react2.useRef)(null);
    const previouslyTagged = (0, import_react2.useRef)(/* @__PURE__ */ new Set());
    const tagAllowedElements = (0, import_react2.useCallback)(() => {
      ...
      previouslyTagged.current = /* @__PURE__ */ new Set();
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ds_exports.GraduationCap, { style: { width: 18, height: 18, flexShrink: 0 } }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { "data-testid": "lesson-mode-hint", children: hint ?? "Lesson mode active — only highlighted controls are available" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
                Button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ds_exports.X, { style: { width: 14, height: 14, marginRight: 4 } }),
                    "Exit"
                  ]
                }
              )
  ...
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "div",
    {
  ...
  function Active() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Surface, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "rounded-md border border-border bg-card p-4 text-sm", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "font-medium", children: "Guided lesson: Blink an LED" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "mt-1 text-muted-foreground", children: "Only the highlighted controls are interactive while the lesson is running." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(LessonModeOverlay, {})
    ] });
  }
  function StepContext() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Surface, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "rounded-md border border-border bg-card p-4 text-sm", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "font-medium", children: "Step 2 of 5 - Wire pin 13 to the LED" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "mt-1 text-muted-foreground", children: "Drag from D13 on the Arduino Uno to the anode of the LED on the breadboard." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(LessonModeOverlay, {})
    ] });
  }
  return __toCommonJS(LessonModeOverlay_exports);
})();
