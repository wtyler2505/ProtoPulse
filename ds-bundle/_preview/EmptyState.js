...
var __dsPreview = (() => {
  ...
  __export(EmptyState_exports, {
    NoErcViolations: () => NoErcViolations,
    NoParts: () => NoParts,
  ...
  function EmptyState({ icon: Icon, title, description, actionLabel, onAction, actionTestId, className }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-14 h-14 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "w-7 h-7 text-primary/60" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-1.5 max-w-sm", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { "data-testid": "empty-state-title", className: "text-base font-semibold text-foreground", children: title }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { "data-testid": "empty-state-description", className: "text-sm text-muted-foreground leading-relaxed", children: description })
          ] }),
  ...
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bg-background text-foreground", style: { padding: 24, minHeight: 280 }, children });
  function NoParts() {
  ...
  function NoErcViolations() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      EmptyState,
      {
        icon: ds_exports.TriangleAlert,
