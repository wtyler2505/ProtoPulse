...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/PredictionCard.tsx
  var PredictionCard_exports = {};
  __export(PredictionCard_exports, {
  ...
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bg-background text-foreground", style: { padding: 24, maxWidth: 380 }, children });
  var noop = () => void 0;
  var missingDecoupling = {
    id: "pred-decap-u3",
    ruleId: "missing-decoupling-cap",
    title: "Add a decoupling capacitor near U3",
    description: "The ATmega328P at U3 has no 100 nF decoupling capacitor within 5 mm of its VCC pin. Place a 0.1 µF X7R cap between VCC and GND to suppress switching noise.",
    confidence: 0.92,
  ...
  var seriesResistor = {
    ...
    description: "LED D1 connects directly between GPIO13 and GND with no series resistor. At 5 V this exceeds the forward current rating. Add a 330 Ω resistor in series.",
    confidence: 0.78,
    category: "safety",
    action: {
      type: "add_component",
  ...
  function MissingComponent() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PredictionCard, { prediction: missingDecoupling, onAccept: noop, onDismiss: noop }) });
  }
  function SafetyWarning() {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PredictionCard, { prediction: seriesResistor, onAccept: noop, onDismiss: noop }) });
  }
  return __toCommonJS(PredictionCard_exports);
})();
