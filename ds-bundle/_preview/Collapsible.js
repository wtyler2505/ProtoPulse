...
var __dsPreview = (() => {
  ...
  var CollapsibleContent = React9.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CollapsibleContentImpl, { ...contentProps, ref: forwardedRef, present }) });
    }
  );
  ...
  var Surface = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "bg-background text-foreground", style: { padding: 24, maxWidth: 360 }, children });
  function NetDetails() {
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Collapsible2, { defaultOpen: true, className: "space-y-2 rounded-md border border-border p-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-sm font-medium", children: "Net: 3V3 · 12 nodes" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(CollapsibleTrigger2, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Button, { variant: "ghost", size: "icon", "aria-label": "Toggle net details", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ds_exports.ChevronsUpDown, {}) }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(CollapsibleContent2, { className: "space-y-1 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "U1.VCC → C3.1 → C4.1" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "U2.VDD → R7.2" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "J1.2 (header 3V3 in)" })
      ] })
    ] }) });
  }
  function AdvancedExportOptions() {
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Surface, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Collapsible2, { className: "space-y-2 rounded-md border border-border p-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(CollapsibleTrigger2, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Button, { variant: "outline", className: "w-full justify-between", children: [
        "Advanced Gerber options",
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ds_exports.ChevronsUpDown, { className: "h-4 w-4" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(CollapsibleContent2, { className: "space-y-1 pt-1 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "Format: RS-274X (extended)" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "Units: millimeters, 4.6 precision" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: "Include: drill map, board outline, paste layers" })
      ] })
    ] }) });
  }
