...
scc --no-cocomo /home/wtyler/Projects/ProtoPulse
scc /home/wtyler/Projects/ProtoPulse                    # With COCOMO cost estimate

# Quick language breakdown
tokei /home/wtyler/Projects/ProtoPulse

# Cyclomatic complexity summary (top functions)
lizard /home/wtyler/Projects/ProtoPulse --sort cyclomatic_complexity 2>/dev/null | head -40
```

### Project Structure
```bash
# Directory tree (3 levels, excluding noise)
tree /home/wtyler/Projects/ProtoPulse -L 3 -I 'node_modules|.git|dist|build|coverage' --dirsfirst

# Source structure (deeper)
tree /home/wtyler/Projects/ProtoPulse/src -L 4 -I 'node_modules' --dirsfirst 2>/dev/null
tree /home/wtyler/Projects/ProtoPulse/client/src -L 4 -I 'node_modules' --dirsfirst 2>/dev/null
tree /home/wtyler/Projects/ProtoPulse/server -L 4 -I 'node_modules' --dirsfirst 2>/dev/null
```
...
echo "=== Test files ===" && fd -g '*test*' -g '*spec*' -g '__tests__' /home/wtyler/Projects/ProtoPulse --type f -g '!node_modules' 2>/dev/null | wc -l
...
jq '{name, version, description, license}' /home/wtyler/Projects/ProtoPulse/package.json 2>/dev/null
jq '.dependencies | keys' /home/wtyler/Projects/ProtoPulse/package.json 2>/dev/null
jq '.devDependencies | keys' /home/wtyler/Projects/ProtoPulse/package.json 2>/dev/null
jq '.scripts' /home/wtyler/Projects/ProtoPulse/package.json 2>/dev/null
```

### Git Health
```bash
git -C /home/wtyler/Projects/ProtoPulse log --oneline -20
git -C /home/wtyler/Projects/ProtoPulse shortlog -sn --all | head -10
git -C /home/wtyler/Projects/ProtoPulse log --since="30 days ago" --oneline | wc -l
...
Write all results to: `.agents/analysis/phase-0-metrics.md`
...
3. Confirmation that `.agents/analysis/phase-0-metrics.md` has been written
