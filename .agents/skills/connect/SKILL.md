...
1. **`ops/derivation-manifest.md`** — vocabulary mapping, platform hints
   ...
   - Use `vocabulary.cmd_revisit` for the next-phase suggestion
...
8. If task file in context: update the {vocabulary.connect} section
...
- **manual:** Output "Next: {vocabulary.cmd_revisit} [note]" — user decides when to proceed
