...
Use this before changing Labs. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Labs orientation.
...
- Workspace navigation can affect whether Labs is reachable.
