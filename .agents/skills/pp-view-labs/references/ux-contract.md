...
The Labs page should be useful, readable, and easy to recover from.

## Must Hold True

- Lab Templates is visible enough for a user to understand what is happening.
- Experiment Setup is visible enough for a user to understand what is happening.
- Guided Workflow is visible enough for a user to understand what is happening.
- Result Capture is visible enough for a user to understand what is happening.
