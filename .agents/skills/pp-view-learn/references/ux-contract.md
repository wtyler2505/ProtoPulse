...
The Learn page should be useful, readable, and easy to recover from.

## Must Hold True

- Learning Content is visible enough for a user to understand what is happening.
- Search is visible enough for a user to understand what is happening.
- Source Quality is visible enough for a user to understand what is happening.
- View Aware Help is visible enough for a user to understand what is happening.
