# Starter Circuits UX Contract

The Starter Circuits page should be useful, readable, and easy to recover from.

## Must Hold True

- Starter Templates is visible enough for a user to understand what is happening.
- Learning Flow is visible enough for a user to understand what is happening.
- Quick Start is visible enough for a user to understand what is happening.
- Safe Defaults is visible enough for a user to understand what is happening.
