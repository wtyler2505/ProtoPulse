...
- Component Editor can publish current part context to the 3D viewer through `viewer-3d-bridge.ts`; carry verification status, level, trust family, and pin-map confidence.
