# Audit Trail Page Map

Use this before changing Audit Trail. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Audit Trail orientation.
...
- Workspace navigation can affect whether Audit Trail is reachable.
