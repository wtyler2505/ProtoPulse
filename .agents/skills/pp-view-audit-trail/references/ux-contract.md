# Audit Trail UX Contract

The Audit Trail page should be useful, readable, and easy to recover from.

## Must Hold True

- Audit Events is visible enough for a user to understand what is happening.
- Filtering is visible enough for a user to understand what is happening.
- Evidence is visible enough for a user to understand what is happening.
- Traceability is visible enough for a user to understand what is happening.
