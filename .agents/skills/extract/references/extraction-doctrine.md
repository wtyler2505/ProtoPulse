...
>
> Extract always writes v2-preferred values. Legacy values in older knowledge WARN at the gates rather than FAIL — never write them for new notes.
>
> Hard rules:
...
3. Cross-chunk connections get flagged for {vocabulary.cmd_connect}
