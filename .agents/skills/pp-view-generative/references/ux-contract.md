# Generative UX Contract

The Generative page should be useful, readable, and easy to recover from.

## Must Hold True

- AI Generation is visible enough for a user to understand what is happening.
- Proposal Review is visible enough for a user to understand what is happening.
- Adoption Flow is visible enough for a user to understand what is happening.
- Trust Labels is visible enough for a user to understand what is happening.
