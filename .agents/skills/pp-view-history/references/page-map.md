...
Use this before changing History. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level History orientation.
...
- Workspace navigation can affect whether History is reachable.
