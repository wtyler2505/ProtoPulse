...
Use this before changing Comments. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Comments orientation.
...
- Workspace navigation can affect whether Comments is reachable.
