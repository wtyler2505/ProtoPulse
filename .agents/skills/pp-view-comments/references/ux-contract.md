# Comments UX Contract

The Comments page should be useful, readable, and easy to recover from.

## Must Hold True

- Discussion is visible enough for a user to understand what is happening.
- Review Notes is visible enough for a user to understand what is happening.
- Anchors is visible enough for a user to understand what is happening.
- Resolved State is visible enough for a user to understand what is happening.
