...
Use this before changing Patterns. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Patterns orientation.
...
- Workspace navigation can affect whether Patterns is reachable.
