# Circuit Code Page Map

Use this before changing Circuit Code. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Circuit Code orientation.
...
- Workspace navigation can affect whether Circuit Code is reachable.
