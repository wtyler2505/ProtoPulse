# Circuit Code UX Contract

The Circuit Code page should be useful, readable, and easy to recover from.

## Must Hold True

- Generated Circuit Code is visible enough for a user to understand what is happening.
- Code Preview is visible enough for a user to understand what is happening.
- Copy/Export Actions is visible enough for a user to understand what is happening.
- Source Trust is visible enough for a user to understand what is happening.
