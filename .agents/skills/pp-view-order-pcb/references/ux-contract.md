# Order PCB UX Contract

The Order PCB page should be useful, readable, and easy to recover from.

## Must Hold True

- PCB Order Flow is visible enough for a user to understand what is happening.
- Fab Checks is visible enough for a user to understand what is happening.
- Cost/Shipping is visible enough for a user to understand what is happening.
- Final Review is visible enough for a user to understand what is happening.
