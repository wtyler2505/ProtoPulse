# Serial Monitor Page Map

Use this before changing Serial Monitor. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Serial Monitor orientation.
...
- Workspace navigation can affect whether Serial Monitor is reachable.
