...
The Lifecycle page should be useful, readable, and easy to recover from.

## Must Hold True

- Project Lifecycle is visible enough for a user to understand what is happening.
- Maturity Stages is visible enough for a user to understand what is happening.
- Readiness is visible enough for a user to understand what is happening.
- History is visible enough for a user to understand what is happening.
