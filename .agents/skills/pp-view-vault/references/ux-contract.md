...
The Vault page should be useful, readable, and easy to recover from.

## Must Hold True

- Vault Browsing is visible enough for a user to understand what is happening.
- Knowledge Sources is visible enough for a user to understand what is happening.
- Search is visible enough for a user to understand what is happening.
- Provenance is visible enough for a user to understand what is happening.
