...
Use this before changing Tasks. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Tasks orientation.
...
- Workspace navigation can affect whether Tasks is reachable.
