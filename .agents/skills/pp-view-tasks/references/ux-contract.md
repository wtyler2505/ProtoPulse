...
The Tasks page should be useful, readable, and easy to recover from.

## Must Hold True

- Tasks is visible enough for a user to understand what is happening.
- Status Columns is visible enough for a user to understand what is happening.
- Workflow Planning is visible enough for a user to understand what is happening.
- Drag/Drop is visible enough for a user to understand what is happening.
