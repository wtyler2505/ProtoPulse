---
name: pp-view-validation
description: ProtoPulse page intelligence for Validation. Use when working on Validation view behavior, layout, workflow, tests, or page-specific UX.
---

# ProtoPulse Validation

Use this for page-level Validation work: page behavior, layout, tests, workflow clarity.

## When To Use

- Page Behavior work in the Validation area.
- Layout work in the Validation area.
- Tests work in the Validation area.
- Workflow Clarity work in the Validation area.
- Bugs where Validation routing, state, layout, or tests are unclear.
- Any task where a future agent would otherwise need to rediscover Validation file locations.

## Fast Workflow

1. Run `node .agents/skills/pp-view-validation/scripts/inspect-validation.mjs`.
...
Warnings count as defects. Do not call Validation work clean while known test, runtime, or console warnings remain.
