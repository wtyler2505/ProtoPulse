# Digital Twin UX Contract

The Digital Twin page should be useful, readable, and easy to recover from.

## Must Hold True

- Virtual Hardware State is visible enough for a user to understand what is happening.
- 3D/Behavior Preview is visible enough for a user to understand what is happening.
- Sync Health is visible enough for a user to understand what is happening.
- State Confidence is visible enough for a user to understand what is happening.
