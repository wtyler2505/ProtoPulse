# Digital Twin Page Map

Use this before changing Digital Twin. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Digital Twin orientation.
...
- Workspace navigation can affect whether Digital Twin is reachable.
