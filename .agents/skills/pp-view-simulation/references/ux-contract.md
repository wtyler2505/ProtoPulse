# Simulation UX Contract

The Simulation page should be useful, readable, and easy to recover from.

## Must Hold True

- Simulation Setup is visible enough for a user to understand what is happening.
- Run Controls is visible enough for a user to understand what is happening.
- Results Display is visible enough for a user to understand what is happening.
- Error Recovery is visible enough for a user to understand what is happening.
