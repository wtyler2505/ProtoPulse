...
The Dashboard page should be useful, readable, and easy to recover from.

## Must Hold True

- Status Overview is visible enough for a user to understand what is happening.
- Project Health is visible enough for a user to understand what is happening.
- Recent Activity is visible enough for a user to understand what is happening.
- Next Actions is visible enough for a user to understand what is happening.
