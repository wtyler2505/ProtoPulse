# Project Explorer UX Contract

The Project Explorer page should be useful, readable, and easy to recover from.

## Must Hold True

- Project Tree is visible enough for a user to understand what is happening.
- File Navigation is visible enough for a user to understand what is happening.
- Sidebar Density is visible enough for a user to understand what is happening.
- Selection is visible enough for a user to understand what is happening.
