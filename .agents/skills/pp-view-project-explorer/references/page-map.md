# Project Explorer Page Map

Use this before changing Project Explorer. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Project Explorer orientation.
...
- Workspace navigation can affect whether Project Explorer is reachable.
