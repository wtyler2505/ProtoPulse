...
The Inventory page should be useful, readable, and easy to recover from.

## Must Hold True

- Inventory is visible enough for a user to understand what is happening.
- Local Storage is visible enough for a user to understand what is happening.
- Saved Parts is visible enough for a user to understand what is happening.
- Data Recovery is visible enough for a user to understand what is happening.
