# Alternates UX Contract

The Alternates page should be useful, readable, and easy to recover from.

## Must Hold True

- Alternate Parts is visible enough for a user to understand what is happening.
- Comparison is visible enough for a user to understand what is happening.
- Tradeoffs is visible enough for a user to understand what is happening.
- Substitution Safety is visible enough for a user to understand what is happening.
