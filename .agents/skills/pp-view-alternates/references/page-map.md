...
Use this before changing Alternates. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Alternates orientation.
...
- Workspace navigation can affect whether Alternates is reachable.
