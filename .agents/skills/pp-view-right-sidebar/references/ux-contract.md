# Right Sidebar UX Contract

The Right Sidebar page should be useful, readable, and easy to recover from.

## Must Hold True

- Page Behavior is visible enough for a user to understand what is happening.
- Layout is visible enough for a user to understand what is happening.
- Tests is visible enough for a user to understand what is happening.
- Workflow Clarity is visible enough for a user to understand what is happening.
