...
The Arduino page should be useful, readable, and easy to recover from.

## Must Hold True

- Compile/Upload is visible enough for a user to understand what is happening.
- Board Selection is visible enough for a user to understand what is happening.
- Serial Workflow is visible enough for a user to understand what is happening.
- Device Safety is visible enough for a user to understand what is happening.
