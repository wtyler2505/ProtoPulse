# Calculators Page Map

Use this before changing Calculators. It records where the page likely lives and what nearby systems can be affected.
...
- This skill owns page-level Calculators orientation.
...
- Workspace navigation can affect whether Calculators is reachable.
