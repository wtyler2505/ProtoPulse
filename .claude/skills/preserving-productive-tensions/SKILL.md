...
description: Recognize when disagreements reveal valuable context, preserve multiple valid approaches instead of forcing premature resolution. Use when oscillating between equally valid approaches that optimize for different legitimate priorities. Triggers on "trade-offs", "competing priorities", "valid approaches", "conflicting options", "premature resolution", "context-dependent choice".
version: 1.1.0
