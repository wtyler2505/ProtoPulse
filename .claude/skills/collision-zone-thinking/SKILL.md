...
description: Force unrelated concepts together to discover emergent properties - "What if we treated X like Y?" Use when conventional approaches feel inadequate and you need breakthrough innovation by forcing unrelated concepts together. Triggers on "breakthrough", "innovation", "new approach", "what if we treated", "metaphor", "unconventional".
version: 1.2.0
---
...
- **Clear solution exists** → Use proven patterns first
- **Incremental optimization** → Collision is for breakthroughs
- **Time-critical debugging** → Use systematic-debugging instead
- **Well-understood domain** → Don't over-innovate working solutions
...
- `simplification-cascades` - When one insight eliminates many components
- `inversion-exercise` - When assumptions are blocking you
- `when-stuck` - Dispatch to right problem-solving technique

## Changelog

- v1.2.0 (2025-01): Added "When NOT to Use" section, related skills
- v1.1.0 (2024-12): Added quick reference table, process steps
- v1.0.0 (2024-11): Initial collision-zone thinking guide
