# Reweave Actions — Deep Guidance and Examples

Detailed methodology for the five reweave actions, the claim evaluation tests, the interactive proposal format, and the philosophy behind reweaving. The workflow contract lives in SKILL.md; this file carries the examples and extended guidance.
...
## Reweave Proposal Format (interactive mode)
