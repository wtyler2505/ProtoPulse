...
description: Understand how ideas evolved over time to find old solutions for new problems and avoid repeating past failures. Use when questioning "why do we use X", before abandoning approaches, or evaluating "new" ideas that might be revivals. Triggers on "why do we", "history of", "evolution of", "lineage", "past decisions", "decision archaeology", "legacy reasons".
version: 1.1.0
allowed-tools: Bash(git:*), Read, Grep, Glob, mcp__memory__search_nodes
---
