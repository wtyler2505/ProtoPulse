 ...
 * read from localStorage 'pp-anthropic-key' (shared apiKey module) and
 * sent ONLY to Anthropic; the Analyst runs simulations via the app's
 * lazy sim runner and reports with the fidelity manifest.
 * Run-to-completion, no streaming (v0.2).
 */
