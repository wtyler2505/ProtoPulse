...
Sixteen workspaces, one CI gate. Status per stage lives in
[`ROADMAP.md`](../ROADMAP.md) — never here; test-case counts live in
[`.ref/project-dna.md`](../.ref/project-dna.md) (regenerated by live scan) — never here either.
