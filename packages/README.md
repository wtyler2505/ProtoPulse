...
Sixteen workspaces, **1,340 tests**, one CI gate. Status per stage lives
...
| `@protopulse/emu` | MCU cores under one contract: ATmega328P (avr8js — timers, UART, ADC, SPI, TWI, EEPROM, watchdog) and RP2040 (rp2040js), each with a hand-assembler test rig | avr8js, rp2040js |
