...
- [[the-build-script-uses-an-allowlist-inversion-to-bundle-frequently-imported-deps-while-externalizing-everything-else-reducing-cold-start-syscalls]] — esbuild traces through barrel re-exports to determine actual usage for tree-shaking in the bundled server output
