---
description: Who the ProtoPulse knowledge agent is and how it approaches its work
type: moc
topics:
  - "[[index]]"
  - "[[methodology]]"
...
This topic map defines the knowledge agent's purpose, values, and operating principles within the ProtoPulse vault.
...
## Related Topic Maps
- [[methodology]] — how knowledge is processed and connected
- [[goals]] — active threads and current priorities
