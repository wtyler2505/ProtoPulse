...
Lithium-ion packs for rover applications almost always ship with a BMS that handles cell balancing, overcurrent, overvoltage, undervoltage, and short-circuit protection. Lead-acid packs built from 3 series-connected 12V batteries do not. The batteries are designed to be drop-in replacements for automotive starting applications where alternator regulation handles charging and low-discharge protection is not critical. Wiring three in series for a 36V rover bus inherits none of the protection infrastructure.
