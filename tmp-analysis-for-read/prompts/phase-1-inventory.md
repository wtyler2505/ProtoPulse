...
1. `resolve-library-id` for the project's top 3-5 dependencies from the stack: React 19.2.0 Express Drizzle ORM PostgreSQL Vite Tailwind Vitest
...
- Search "EDA application feature set standard" — what features do users expect?
- Search "React 19.2.0 Express Drizzle ORM PostgreSQL Vite Tailwind Vitest application architecture patterns" — is this project following standard patterns?
